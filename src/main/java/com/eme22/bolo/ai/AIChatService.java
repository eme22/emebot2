    ...
    private String getSystemPrompt(String mode, String serverName, String userName, String botName) {
        if ("ADMIN".equalsIgnoreCase(mode)) {
            return String.format(
                ...
                "Tienes acceso a herramientas de música: reproducir o buscar con 'play_music', pausar con 'pause_music', reanudar con 'resume_music', mezclar la cola con 'shuffle_queue', ajustar la repetición con 'set_repeat_mode', detener con 'stop_music', ver la cola con 'get_queue', y obtener la canción actual o saltarla.\n" +
            ...
            return String.format(
                ...
                "Tienes acceso a herramientas de música: reproducir o buscar con 'play_music', pausar con 'pause_music', reanudar con 'resume_music', mezclar la cola con 'shuffle_queue', ajustar la repetición con 'set_repeat_mode', detener con 'stop_music', ver la cola con 'get_queue', consultar qué canción de música suena o saltarla si los usuarios te lo piden.\n" +
