...
public class SetGoodByeMessageCmd extends AdminCommand {
   ...
   public SetGoodByeMessageCmd(@Named("adminCategory") Category category) {
      super(category);
      this.name = "setgoodbyemsg";
      this.help = "cambia el mensaje de despedida";
      this.arguments = "<message>";
      this.options = Collections.singletonList(
         new OptionData(OptionType.STRING, "mensaje", "mensaje a decir cuando un usuario abandona el servidor.").setRequired(true)
      );
   }
